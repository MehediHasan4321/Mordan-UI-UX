    ...
    return (
        <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
            <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
                <div className="flex flex-row items-center py-[6px] px-4 bg-discound-gradient rounded-[10px] mb-2">
                    <img src={discount} alt="discouont" className="h-[32px] w-[32px]" />
                    <p className={`${styles.paragraph} ml-2`}>
                        <span className="text-white"> 20% </span>
                        Discound For <span className="text-white">1 Month</span> Accouont
                    </p>
                </div>
                ...
                <h1 className="font-poppins font-semibold ss:text-[62px] text-[52px] ss:leading-[100px] leading-[75px] text-white">Payment Methods</h1>
